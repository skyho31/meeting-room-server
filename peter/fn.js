...
module.exports = {
  ...
  nomalization ({location, wifiInfo}, wifiListArr, wifiIndexArr) {
  ...
  extract(wifiInfoJSON, wifiListJSON) {
    ...
    return timestampArr.reduce((acc, timestamp) => {
      const {question, answer} = this.nomalization(wifiInfoJSON[timestamp], wifiListArr, wifiIndexArr);
